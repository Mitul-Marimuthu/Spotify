...
from Data_Collector import collect_data, artist_list
...
def pagination_artist_graph():
    ...
    fig, axs = plt.subplots(int(num_pages/2), 2, figsize=(10, 7))  # (num_pages/2) rows, 2 column (adjust figsize as needed)
    counter = 0
